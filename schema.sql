...
-- Password : Admin@123
-- ─────────────────────────────────────────────
-- The hash below is bcrypt of "Admin@123"
-- To regenerate: php -r "echo password_hash('Admin@123', PASSWORD_BCRYPT);"
...
-- ⚠️  NOTE: The hash above is bcrypt of "password" (Laravel default test hash).
-- After importing, run this PHP to get your own hash:
